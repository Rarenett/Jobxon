...
import { admin,adRoute } from "../../../../globals/route-names";
                                                ...
                                                <div className="twm-table-controls">
                                                    <ul className="twm-DT-controls-icon list-unstyled">
                                                        <li>
                                                            ...
                                                            <NavLink to={adRoute(admin.VIEW_APPLIED_CANDIDATES)} className="twm-job-title"> <button title="View profile" data-bs-placement="top" ><span className="fa fa-eye" /></button></NavLink>
